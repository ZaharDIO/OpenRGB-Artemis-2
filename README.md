...
4.7 - Quando terminar de configurar a sua peça clique em Auto Resize e ele fechará o Grid no tamanho perfeito para a sua peça. No Menu Lateral Esquerdo Marque as caixas "Auto Load" e "Auto Register", clique em "VMap Menu", marque a opção "Register Controller" e clique em "Save", coloque o nome da sua peça, vá ao Menu Superior vá em Devices e clique em Save Profile para garantir que suas alterações foram salvas
